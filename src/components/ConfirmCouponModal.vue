<script setup>
defineProps({
  showConfirmCouponModal: Boolean, // 控制 modal 顯示
})
...
<template>
  <div
    v-if="showConfirmCouponModal"
    class="modal fade show d-block"
    id="confirmCouponModal"
    tabindex="-1"
    aria-labelledby="confirmCouponModalLabel"
    aria-hidden="true"
  >
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <p
            ...
            @click="apply"
          >
            {{ $t('confirm_coupon_modal.confirm') }}
          </p>
        </div>
      </div>
    </div>

  ...
  <form>
    ...
    <div class="mb-3">
      <label for="bus_count" class="form-label">
        <span>{{ $t('pages.applyEventCoupon.form.bus_count') }}&nbsp;</span>
    ...
    <div class="mb-3">
      <label for="car_count" class="form-label">
        <span>{{ $t('pages.applyEventCoupon.form.car_count') }}&nbsp;</span>
        <span class="text-primary">{{
    ...
    <div class="note">
      <p class="text-danger">
        <span>
          {{ $t('pages.applyEventCoupon.form.note_title') }}
          <br />
        </span>
        <span>
          {{ $t('pages.applyEventCoupon.form.note_content') }}
        </span>
      </p>
    </div>
    <div class="text-center">
      <button class="btn btn-secondary w-100" @click.prevent="handleNext">
        {{ $t('pages.applyEventCoupon.form.print') }}
      </button>
    </div>
  </form>
  <div class="mt-3 text-center">
    <button class="btn btn-secondary w-100" @click="goToUploadDocuments">
      {{ $t('pages.applyEventCoupon.form.uploadDocuments') }}
    </button>
  </div>
